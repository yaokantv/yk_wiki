...
var localizedPath = ['docs', 'api', 'docs_ios', 'docs_android','yksdk','ykzxsdk','cloudapi'];
...
hexo.extend.helper.register('header_menu', function(className) {
  ...
  // result = '<ul >'+
	//   '<li class="levelA"><a class="main_a" href="/zh-cn/overview/overview.html">平台概述</a></li>'+
	//   '<li class="levelA"><a class="main_a">top1</a> '+
	// 	  '<ul class="levelB-wrapper" style="display: none" >'+
	// 		'<li class="levelB"><a class="sub_a" href="/zh-cn/quickstart/5分钟了解机智云.html">aaaaaaaaa</a></li>'+
	// 		'<li class="levelB"><a class="sub_a" href="/zh-cn/quickstart/noun.html">bbbbbbbbbbbbbbb</a></li>'+
	// 	  '</ul>'+
	//   '</li>'+
  // '</ul>';
...
hexo.extend.helper.register('raw_link', function(path) {
  return 'https://github.com/yaokantv/yk_wiki/edit/master/source/' + path;
});
